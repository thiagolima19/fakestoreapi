...
document.getElementById("sort").addEventListener("change", fecthAndShowData);
document.getElementById("category").addEventListener("change", fecthAndShowData);
